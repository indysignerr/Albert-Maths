...
export const fr: PartialDictionary = {
  ...
  classes: {
    ...
    members: "{n} membres",
    memberList: "Dans cette classe",
    you: "toi",
    founder: "a créé la classe",
    shareToClass: "Demander à ma classe",
    sharePrompt: "Qu’est-ce qui te bloque ?",
    shareSend: "Publier dans ma classe",
    shared: "Publié dans ta classe.",
    sharedExercise: "Bloqué sur ça",
    today: "Aujourd’hui",
    open: "Ouvrir",
    leave: "Quitter",
